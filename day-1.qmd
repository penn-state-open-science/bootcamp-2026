...
|--------------|----------|-------|
| [*Getting credit (Part I): Good enough data management practices*](sessions.html#getting-credit-part-i-good-enough-data-managment-practices) ![](include/img/Nittany-Lion-Lab-Coat-2){width="30px"} | [Alaina Pearce](directors.qmd#alaina-pearce)| Dewey Room |
| [*A gentle introduction to Git: A graphical overview of version control for computational workflows*](sessions.html#a-gentle-introduction-to-git-a-graphical-overview-of-version-control-for-computational-workflows) | [Carrie Brown](program-committee.qmd#carrie-brown) | W211A Pattee |
...
| [*Getting credit (Part II): Making your data make sense*](sessions.html#getting-credit-part-ii-making-your-data-make-sense) ![](include/img/Nittany-Lion-Lab-Coat-2){width="30px"} |  [Alaina Pearce](directors.qmd#alaina-pearce) | Dewey Room |
...
![](include/img/Nittany-Lion-Lab-Coat-2){width="30px"} This workshop contributes to the Provost Endorsement in Research Data Stewardship. Register for the program [here](https://pennstate.qualtrics.com/jfe/form/SV_0ppydquaUVYUN3U).
