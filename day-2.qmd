...
| Topic | Presenter | Location |
|--------------|----------|-------|
| *Quarto (Part III): Reproducible research reports* | [John West](program-committee.qmd#john-west) | W211A Pattee | 
| *Questionable research practices* |  [Jennifer Valcin](program-committee.qmd#jennifer-valcin) | TBD |
| *Introduction to Python and Jupyter notebooks* | Dewey Room |
